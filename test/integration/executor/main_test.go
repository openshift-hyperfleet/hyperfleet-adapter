...
// sharedEnv holds the shared test environment for executor integration tests
var sharedEnv *K8sTestEnv
...
func TestMain(m *testing.M) {
	...
	if sharedEnv != nil && sharedEnv.cleanup != nil {
		println()
...
// setupSharedEnvtestEnv creates the shared envtest environment for executor tests
func setupSharedEnvtestEnv() (*K8sTestEnv, error) {
