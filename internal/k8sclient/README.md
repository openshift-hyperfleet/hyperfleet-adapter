...
**Package:** `github.com/openshift-hyperfleet/hyperfleet-adapter/internal/k8sclient`
...
See `test/integration/k8sclient/` for integration test examples and setup guide.
